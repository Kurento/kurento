...
public class ReturnReferencesTest {
  ...
  public static void initFactory() {
    manager =
        new RomManager(new RomClientJsonRpcClient(new JsonRpcClientLocal(
  ...
  public void objectRefTest() {
    ...
    SampleClass obj =
        new SampleClass.Builder("AAA", false, manager).withAtt3(0.5f).withAtt4(22).build();

    SampleClass obj2 =
        new SampleClass.Builder("BBB", false, manager).withAtt3(0.5f).withAtt4(22).build();
