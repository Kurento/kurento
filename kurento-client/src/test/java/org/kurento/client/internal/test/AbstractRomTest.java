...
public abstract class AbstractRomTest {
  ...
  protected abstract void startJsonRpcServer(RomServerJsonRpcHandler jsonRpcHandler);
  ...
  public void useRom(JsonRpcClient client) {
    ...
    SampleClass obj =
        new SampleClass.Builder("XXX", false, manager).withAtt3(0.5f).withAtt4(22).build();
    ...
    for (int i = 0; i < 5; i++) {
      ...
      List<SampleEnum> result =
          obj.echoListEnum(Arrays.asList(SampleEnum.CONSTANT_1, SampleEnum.CONSTANT_2));
