...
public class RomServer {
  ...
  public String create(String remoteClassType, Props constructorParams) {
    ...
    try {
      ...
      Object[] unflattenedConstParams =
          FLATTENER.unflattenParams(constructor.getParameterAnnotations(),
              constructor.getGenericParameterTypes(), constructorParams, manager);
  ...
  public Object invoke(String objectRef, String methodName, Props params, Type type) {
    ...
    try {
      ...
      Object[] unflattenParams =
          FLATTENER.unflattenParams(method.getParameterAnnotations(),
      ...
      throw new ProtocolException("Invocation exception of object with remoteClass='"
          + remoteObjClass.getSimpleName() + "', method=" + methodName + " and params=" + params, e);
    }
  }
