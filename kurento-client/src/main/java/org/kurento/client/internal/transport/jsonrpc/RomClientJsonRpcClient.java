...
public class RomClientJsonRpcClient implements RomClient {
  ...
  public Object invoke(String objectRef, String operationName, Props operationParams, Type type,
    ...
    RequestAndResponseType reqres =
        createInvokeRequest(objectRef, operationName, operationParams, type, false);
  ...
  @SuppressWarnings("unchecked")
  private <P, R> R processReqResult(final Type type, Function<P, R> processor, JsonElement reqResult) {
  ...
  public RequestAndResponseType createUnsubscribeRequest(String objectRef,
    ...
    JsonObject params =
        JsonUtils.toJsonObject(new Props(UNSUBSCRIBE_OBJECT, objectRef).add(UNSUBSCRIBE_LISTENER,
