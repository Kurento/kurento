 ...
 * @version 1.0.1
 */
@HttpRecorderService(path = "/recorderTunnel", useControlProtocol = false)
public class RecorderTunnel extends AbstractBaseRecorder {

	@Override
	protected String getUri() {
		return "file:///tmp/recorderTunnel";
	}
