...
DEBIAN_FRONTEND=noninteractive sudo apt-get update || echo "Error updating packages"
...
DEBIAN_FRONTEND=noninteractive sudo apt-get install --force-yes -y $pkgs || exit 1
