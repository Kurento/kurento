...
public class JsonRpcHandlerTypesTest {
  ...
  public void getParamsTypeTest() {
    ...
    Assert.assertEquals(Params.class, JsonRpcHandlerManager.getParamsType(
        new PerSessionJsonRpcHandler<Params>(null, JsonRpcHandlerDefault.class).getHandlerType()));
