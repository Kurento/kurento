package org.kurento.kmf.rabbitmq.client;

import static org.kurento.kmf.jsonrpcconnector.JsonUtils.fromJsonRequest;
import static org.kurento.kmf.rabbitmq.RabbitMqManager.PIPELINE_CREATION_QUEUE;
...
import org.kurento.kmf.rabbitmq.RabbitMqManager.BrokerMessageReceiver;
import org.kurento.kmf.rabbitmq.RabbitTemplate;
