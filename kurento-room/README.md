...
Kurento Room is composed by several modules to offer a group communications by
means of WebRTC. The modules are: kurento-room-server, kurento-room-client and
kurento-room-demo.
