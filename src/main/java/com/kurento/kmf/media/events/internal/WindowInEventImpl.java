...
/**
 * Default implementation of {@link WindowInEvent}
 * 
 * @author Ivan Gracia (igracia@gsyc.es)
 * 
 */
@ProvidesMediaEvent(type = EVENT_WINDOW_IN)
public class WindowInEventImpl extends AbstractMediaEvent<StringMediaParam>
		implements WindowInEvent {

	/**
	 * @param event
	 *            The Thrift event received form the server.
	 */
	public WindowInEventImpl(KmsMediaEvent event) {
		super(event);
	}
