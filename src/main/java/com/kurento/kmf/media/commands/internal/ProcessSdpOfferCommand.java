...
import static com.kurento.kms.thrift.api.SdpEndPointTypeConstants.PROCESS_SDP_OFFER;

import com.kurento.kmf.media.internal.ProvidesMediaCommand;

@ProvidesMediaCommand(type = PROCESS_SDP_OFFER, resultClass = StringCommandResult.class)
public class ProcessSdpOfferCommand extends StringCommand {

	public ProcessSdpOfferCommand(String sdp) {
		super(PROCESS_SDP_OFFER, sdp);
	}
}
