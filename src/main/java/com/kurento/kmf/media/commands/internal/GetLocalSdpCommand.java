...
import static com.kurento.kms.thrift.api.SdpEndPointTypeConstants.GET_LOCAL_SDP;

import com.kurento.kmf.media.internal.ProvidesMediaCommand;

@ProvidesMediaCommand(type = GET_LOCAL_SDP, resultClass = StringCommandResult.class)
