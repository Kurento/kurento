...
public interface MediaPipeline extends MediaObject {
	...
	/**
	 * Obtains the builder for an {@link HttpGetEndpoint}.
	 * 
	 * @return The builder
	 */
	...
	/**
	 * Obtains the builder for an {@link HttpPostEndpoint}.
	 * 
	 * @return The builder
	 */
	HttpPostEndpointBuilder newHttpPostEndpoint();
	...
	/**
	 * Obtains the builder for a {@link DispatcherMixerBuilder}.
	 * 
	 * @return The builder
	 */
