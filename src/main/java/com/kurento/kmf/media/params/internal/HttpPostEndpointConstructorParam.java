...
import com.kurento.kms.thrift.api.KmsMediaHttpPostEndPointConstructorParams;
...
public class HttpPostEndpointConstructorParam extends
	...
	public HttpPostEndpointConstructorParam() {
		super(CONSTRUCTOR_PARAMS_DATA_TYPE);
	}

	@Override
	protected TProtocol serializeDataToThrift(TProtocol pr) {
		KmsMediaHttpPostEndPointConstructorParams kmsParams = new KmsMediaHttpPostEndPointConstructorParams();
	...
	public boolean equals(Object obj) {
		...
		HttpPostEndpointConstructorParam param = (HttpPostEndpointConstructorParam) obj;
