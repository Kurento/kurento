...
/**
 * HTTP Player Handler; redirect strategy; no JSON control protocol.
 * 
 * @author Boni García (bgarcia@gsyc.es)
 * @since 1.0.0
 */
@HttpPlayerService(path = "/player-redirect/*", redirect = true, useControlProtocol = false)
public class PlayerRedirect extends HttpPlayerHandler {
