...
public class Code {
	...
	public void completeInfo(ModuleDefinition module,
		...
		putDefault(implementation, "cppNamespace",
				"kurento::module::" + module.getName());
		putDefault(implementation, "lib",
				"libkms" + module.getName().toLowerCase());

		if (kmd != null) {
			putDefault(kmd, "java", "mavenGroupId", "org.kurento.module");
			putDefault(kmd, "java", "mavenArtifactId",
					module.getName() + ".kmd");
