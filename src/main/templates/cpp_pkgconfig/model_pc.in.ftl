...
Requires:<#if !model.imports[0]?? > gstreamer-1.0 >= 1.3.3 gstreamer-sdp-1.0 >= 1.3.3 libjsonrpc >= 0.0.6 sigc++-2.0 >= 2.0.10 glibmm-2.4 >= 2.37<#else><#rt>
<#list model.imports as import>${import.model.code.implementation.lib?replace("lib", "")} </#list><#rt>
</#if> @requires@
Requires.private:
