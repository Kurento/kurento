...
/**
 *
 * Interface to be implemented by {@link MediaEvent} listeners.
 * Implementors of this interface will be on charge of processing
 * the events raised by media elements.
 *
