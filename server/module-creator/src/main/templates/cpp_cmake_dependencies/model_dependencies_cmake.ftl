...
<#list module.imports as import>
  <#noparse>${</#noparse>${import.module.code.implementation.lib?replace("^lib", "", "r")?upper_case}_LIBRARIES<#noparse>}</#noparse>
</#list>
...
<#list module.imports as import>
  <#noparse>${</#noparse>${import.module.code.implementation.lib?replace("^lib", "", "r")?upper_case}_INCLUDE_DIRS<#noparse>}</#noparse>
</#list>
  CACHE INTERNAL "Model library dependencies"
)
