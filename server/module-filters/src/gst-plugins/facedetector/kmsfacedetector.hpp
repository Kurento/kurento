...
#define KMS_FACE_DETECTOR(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST ((obj), KMS_TYPE_FACE_DETECTOR, KmsFaceDetector))
#define KMS_FACE_DETECTOR_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST ((klass), KMS_TYPE_FACE_DETECTOR, \
      KmsFaceDetectorClass))
#define KMS_IS_FACE_DETECTOR(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE ((obj), KMS_TYPE_FACE_DETECTOR))
#define KMS_IS_FACE_DETECTOR_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE ((klass), KMS_TYPE_FACE_DETECTOR))
