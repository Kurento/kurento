...
if [[ "$CFG_RELEASE" == "true" ]]; then
    run_jq "
        .dependencies.\"kurento-client-core\" = \"$VERSION\"
        | .dependencies.\"kurento-client-elements\" = \"$VERSION\"
        | .dependencies.\"kurento-client-filters\" = \"$VERSION\"
        | .dependencies.\"kurento-jsonrpc\" = \"$VERSION\"
    " package.json
else
    run_jq "
