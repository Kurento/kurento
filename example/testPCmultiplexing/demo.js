...
function createKwsMedia(stream, videoOutput, callback)
{
...
getUserMedia({'audio': true, 'video': true}, function(stream)
{
  ...
  var videoOutput3 = document.getElementById('videoOutput3');

  videoInput.src = URL.createObjectURL(stream);

  createKwsMedia(stream, videoOutput, function(stream)
  {
    createKwsMedia(stream, videoOutput2);
    createKwsMedia(stream, videoOutput3);
  });
},
onerror);
