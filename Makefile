...
KMS_VERSION = 6.5.1-dev
CLIENT_JAVA_VERSION = 6.5.1-SNAPSHOT
CLIENT_JS_VERSION = 6.5.1-dev
UTILS_JS_VERSION = 6.5.1-dev
TUTORIAL_JAVA_VERSION = 6.5.1-SNAPSHOT
TUTORIAL_JS_VERSION = 6.5.1-dev
TUTORIAL_NODE_VERSION = 6.5.1-dev
