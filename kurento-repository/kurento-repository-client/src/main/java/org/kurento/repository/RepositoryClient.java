...
/**
 * Client API for the Kurento repository server application. It uses REST as
 * means of communicating with the server.
 * 
...
public interface RepositoryClient {
	...
	/**
	 * Creates a new repository item with the provided metadata, ready for media
	 * recording.
	 * 
	 * @param metadata a map of values. Can be empty but <strong>not
	 *        null</strong>.
	 * @return a {@link RepositoryItemRecorder} containing the item's id and an
	 *         URL through which Kurento Media Server can record media sent by
	 *         the client
	 */
	@POST("/repo/item")
	 ...
	 * 
	 * @param itemId the id of an existing repository item
	 ...
	 * 
	 * @param itemId the id of an existing repository item
	 * @return a {@link RepositoryItemPlayer} containing the item's id and an
	 *         URL from which Kurento Media Server can play (serve) stored media
	 *         streams
	 */
	 ...
	 * expected values.
	 * 
	 * @param searchValues pairs of attributes and their values
	...
	/**
	 * Searches for repository items by each pair of attributes whose values can
	 * be regex Strings.
	 * 
	 * @param searchValues pairs of attributes and their values
	 * @return a {@link Set}&lt;{@link String}&gt; with identifiers of the
