# -*- coding: utf-8 -*-
#
# Kurento Repository documentation build configuration file, created by
...
project = u'Kurento Repository'
copyright = u'2015, kurento.org'
release = u'6.1.1-SNAPSHOT'
...
latex_documents = [
  ('pdfindex', 'KurentoRepository.tex', u'KurentoRepository Documentation',
...
man_pages = [
    ('index', 'kurentoRepository', u'KurentoRepository Documentation',
     [u'kurento.org'], 1),
...
texinfo_documents = [
  ('index', 'KurentoRepository', u'KurentoRepository Documentation',
   u'kurento.org', 'KurentoRepository', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'KurentoRepository'
epub_author = u'KurentoRepository'
epub_publisher = u'KurentoRepository'
