...
docker run \
  ...
  $([ "${AWS_ACCESS_KEY_ID}x" != "x" ] && echo | awk '{print "-e \"AWS_ACCESS_KEY_ID=$AWS_ACCESS_KEY_ID\""}') \
  $([ "${AWS_SECRET_ACCESS_KEY}x" != "x" ] && echo | awk '{print "-e \"AWS_SECRET_ACCESS_KEY=$AWS_SECRET_ACCESS_KEY\""}') \
