...
import org.kurento.kmf.jsonrpcconnector.server.JsonRpcHandlerRegistration;

/**
 * Base class for {@link WebSocketHandlerRegistration}s that gathers all the
 * configuration options but allows sub-classes to put together the actual HTTP
 * request mappings.
 * 
