...
/**
  ...
  *
  * Builds a {@code <T>} object, either
  * synchronously using {@link #build}
  * or asynchronously using {@link #buildAsync}
  *
...
public interface AbstractBuilder<T> {
	...
	/**
	  ...
	  *
	  * @param Continuation<T> will be called when the object is built
	  *
	  *
	  **/
