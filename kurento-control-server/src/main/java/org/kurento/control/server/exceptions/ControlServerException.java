 ...
 *
 */
public class ControlServerException extends KurentoException {
	 ...
	 * @param msg
	 */
	public ControlServerException(String msg) {
		super(msg);
	}
	 ...
	 * @param cause
	 */
	public ControlServerException(String msg, Throwable cause) {
		super(msg, cause);
	}
