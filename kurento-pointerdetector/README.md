...
Kurento pointer detector Node.js tutorial
=========================================

This project creates a loopback from your webcam that detect a color and send
back a video stream with a point on it.
