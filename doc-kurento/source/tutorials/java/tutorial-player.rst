...
`GitHub <https://github.com/Kurento/kurento/tree/main/tutorials/java/player>`_.
...
`PlayerApp <https://github.com/Kurento/kurento/blob/main/tutorials/java/player/src/main/java/org/kurento/tutorial/player/PlayerApp.java>`_.
...
`PlayerHandler <https://github.com/Kurento/kurento/blob/main/tutorials/java/player/src/main/java/org/kurento/tutorial/player/PlayerHandler.java>`_
...
`index.html <https://github.com/Kurento/kurento/blob/main/tutorials/java/player/src/main/resources/static/index.html>`_
web page, and are used in the
`index.js <https://github.com/Kurento/kurento/blob/main/tutorials/java/player/src/main/resources/static/js/index.js>`_.
