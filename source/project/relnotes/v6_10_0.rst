...
However, starting from `Boost version 1.59.0 <https://www.boost.org/users/history/version_1_59_0.html>`__, the JSON parser was rewritten without any consideration for backwards-compatibility (yeah, a bit of "*Do NOT break users*" philosoy from Linus Torvalds or a bit of Semantic Versioning love wouldn't be a bad thing for these people to gain...) so it started leveraging the great capability of not allowing comments from the JSON standard.
...
- [@prlanzarin](https://github.com/prlanzarin) (Paulo Lanzarin)
  - Add API support for MKV profile for recordings [Kurento/kms-core#14](https://github.com/Kurento/kms-core/pull/14), [Kurento/kms-elements#13](https://github.com/Kurento/kms-elements/pull/13)
  - Fixed config-interval prop type checking in basertpendpoint and rtppaytreebin [Kurento/kms-core#15](https://github.com/Kurento/kms-core/pull/15)
...
TRANSCODING ACTIVE
the troubleshooting page has been updated with the new messages.
