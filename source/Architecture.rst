...
`180x100px\|center\|Media Element <Image:Media_element.png>`__
...
| **Figure 1**.
| *A media element is a functional unit providing a specific media
capability, which is exposed to application developers as a "black box"*
...
`600x450px\|center\|Media Pipeline
Example <Image:Media_pipeline_example.png>`__
...
application receiving media from a video source, injecting a love-heart
animation in the video stream when a specific face has been recognized
and sending the resulting media to a video sink*
...
`600x215px\|center\|Media Element <Image:AgnosticMediaAdaptor.png>`__
...
`800x600px\|center\|Stream-oriented GE
Architecture <Image:Stream-oriented_GE.png>`__
...
| **Figure 4**.
| *The Stream Oriented GE architecture follows the traditional
separation between signaling and media planes.*
...
`500x386px\|center\|Onion like layered structure of the
APIs <Image:Onion_like_APIs.png>`__
...
| 
|  Following this, the role of the different APIs can be summarized in
the following way:
...
`500x398px\|center\|Creating client applications through the Stream
Oriented GE APIs <Image:Consuming_the_APIs.png>`__
...
-  **Presentation layer**: Is in charge of multimedia representation and
   ...
   tag or the WebRTC PeerConnection and MediaStreams APIs.
...
`500x278px\|center\|Layered architecture of web and multimedia
applications <Image:Applications_Layered_Architecture.png>`__
...
`720px\|center\|Main interactions between architectural
modules <Image:Generic_interactions.png>`__
...
`720px\|center\|Main interactions in a Stream Oriented GE session
devoted to playing an HTTP media stream <Image:Player_session.png>`__
...
`720px\|center\|Example of pipeline for an HTTP content player
session <Image:Player_session_pipeline.png>`__
...
`720px\|center\|Example of pipeline for an HTTP content recorder
session <Image:Recorder_session.png>`__
...
`720px\|center\|Main interactions in a RTC
session <Image:RTC_session.png>`__
...
`720px\|center\|Example pipeline for a WebRTC
session <Image:RTC_session_pipeline.png>`__
