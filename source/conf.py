...
project = u'Kurento'
copyright = u'2014, kurento doc team'

# The version info for the project you're documenting, acts as replacement for
# |version|, used in several places throughout the built documents.
# We can't use the sphinx substitution mechanism because it does not work
...
# Overwrite the theme with the ReadTheDocs theme is available. Do 'pip install 
# sphinx_rtd_theme' to install on your system.
...
texinfo_documents = [
  ('index', 'Kurento', u'Kurento Documentation',
   u'kurento doc team', 'Kurento', 'One line description of project.',
   'Miscellaneous'),
]
