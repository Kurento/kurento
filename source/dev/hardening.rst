...
Kurento Media Server had been lagging in this respect, and old releases only implemented `the most basic hardening`_ that is applied by the *dpkg-buildflags* tool by default:
...
Starting from version 6.7.0, KMS also implements these extra hardening features:
...
.. _the most basic hardening: https://wiki.debian.org/HardeningWalkthrough#Selecting_security_hardening_options
