%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Java Tutorial 10 - Show DataChannel
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
by one **WebRtcEndpoint** and one **KmsSendData**.
The text type in the textbox is sent through data channels (**KmsSendData**) from the Kurento media server 
to the browser (**WebRtcEndpoint**) and shows the info on video.
...
(``WebRtcEndpoint`` and ``KmsSendData``) and make the connections among
