%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Java Tutorial 6 - Group Call
%%%%%%%%%%%%%%%%%%%%%%%%%%%%

This tutorial allows connect several participants in the same session and see each of them using 
`WebRTC`:term: technology. It is a conference call.
