%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
JavaScript Tutorial 2 - One to one video call
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
.. figure:: ../../images/kurento-js-tutorial-2-one2one-screenshot.png
   :align:   center
...
.. figure:: ../../images/kurento-js-tutorial-2-one2one-signaling.png
   :align:   center
