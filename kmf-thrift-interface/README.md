...
==========
Thrift interface consumer/server for the Kurento Media Framework

This project handles the thrift communication between the Kurento
Media Server and java processes.
...
[GitHub Repository]: https://github.com/kurento/kmf-thrift-interface
