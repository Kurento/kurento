...
==========
Kurento Content Management API demo for FI-WARE

The fi-lab-demo project is a demo of the Kurento Content Management API
done in the scope of the FI-WARE project.
...
[GitHub Repository]: https://github.com/kurento/fi-lab-demo
