...
changelink "#configuration-guide" "mastering/configuration_guide.html" "./build/html/mastering_kurento.html"
...
changelink "mastering_kurento.html#configuration-guide" "mastering/configuration_guide.html" "./build/html/index.html"
...
files=(kurento_architecture kurento_API kurento_protocol configuration_guide kurento_development kurento_modules develop_kurento_modules webrtc_statistics)
for i in ${files[@]}
do
   ...
   changelink "mastering_kurento.html#configuration-guide" "mastering/configuration_guide.html" "./build/html/mastering/${i}.html"
