 ...
 * Composite. The resulting video is recording using a RecorderEndpoint. The
 * recorded video is played using a PlayerEndpoint.<br/>
 * 
 * Media Pipeline(s): <br>
 ...
 * and it records the grid using the RecorderEndpoint. <br>
 ...
 * 
 * Main assertion(s): <br>
 * · Color of the video should be the expected in the recorded video (red,
 * green, blue, and white)<br>
 * 
...
public class CompositeRecorderTest extends BaseRecorder {
	...
	public CompositeRecorderTest(TestScenario testScenario) {
		super(testScenario);
	}
	...
	public void testCompositeRecorder() throws Exception {
		...
		launchBrowser(mp, webRtcEP2, playerEP2, null,
				EXPECTED_VIDEO_CODEC_WEBM, EXPECTED_AUDIO_CODEC_WEBM,
				recordingFile, Color.RED, 0, 0, PLAYTIME);

		// Assertions
		Assert.assertTrue("Upper left part of the video must be red", getPage()
				.similarColorAt(Color.RED, 0, 0));
