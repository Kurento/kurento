...
/**
 * Stability test for Recorder. Record 100 files (2 seconds) from the same WebRtcEndpoint. <br>
 *
 * Media Pipeline(s): <br>
 ...
 * 2. (KMS) WebRtcEndpoint receives media and it is recorded by RecorderEndpoint. <br>
 *
 * Main assertion(s): <br>
