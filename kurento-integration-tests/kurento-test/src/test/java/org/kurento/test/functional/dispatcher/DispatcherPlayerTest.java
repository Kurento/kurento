 ...
 *
 * Test logic: <br>
 * 1. (KMS) Media server switchs the media from two PlayerEndpoint using a Dispatcher, streaming the
 * result through a WebRtcEndpoint<br>
 * 2. (Browser) WebRtcPeer in rcv-only receives media <br>
 *
 * Main assertion(s): <br>
 * · Playing event should be received in remote video tag <br>
 * · The color of the received video should be as expected (red and the blue) <br>
