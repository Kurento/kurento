 ...
 * Composite. Only audio is connected for three players. The resulting video is
 * recording using a RecorderEndpoint. The recorded video is played using a
 * PlayerEndpoint.<br/>
 * 
 * Media Pipeline(s): <br>
 ...
 * 
 * Test logic: <br>
 * 1. (KMS) Media server mix the media from 4 PlayerEndpoints and it records the
...
public class CompositeAudioRecorderTest extends BaseRecorder {
	...
	public CompositeAudioRecorderTest(TestScenario testScenario) {
		super(testScenario);
	}
