...
public class DockerTest extends KurentoTest {
  ...
  public void executionContainerized() {
    ...
    assertEquals("shouldBeInContainer=" + shouldBeInContainer + " and isRunningInContainer="
        + isRunningInContainer + " should be equals", shouldBeInContainer, isRunningInContainer);
  }
