...
public class Shell {
  ...
  public static Process run(boolean redirectOutputs, final String... command) {
    ...
    try {
      ...
      throw new RuntimeException("Exception while executing command '" + Arrays.toString(command)
          + "'", e);
    }
  }
  ...
  public static String runAndWaitNoLog(final String... command) {
    ...
    try {
      ...
      throw new KurentoException("Exception executing command on the shell: "
