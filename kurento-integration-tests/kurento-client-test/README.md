...
kmf-media-api-test
==========
Tests for the KMF Media API

This project includes tests for the Kurento Media Framework Media API. This API
allows writing of server applications that control media server resources.
