 ...
 * @param parent
 * @param pipeline
 * @param {module:KwsMedia/elements~MediaObject.ConstructorParams} params
 */
function MediaElement(objectRef, parent, pipeline, params)
{
   ...
   *
   *
   * @param {module:KwsMedia~MediaElement} sink - Element to connect
   * @param {module:KwsMedia~MediaPad.MediaType} [type] - Type of the sink pads to be fetched
   * @param {external:String} [description] -
   *
   * @return {module:KwsMedia~MediaElement} The element itself
   *
   * @throws {MediaServerException}
   */
 ...
 * @throws {SyntaxError}
 *
 * @returns {module:KwsMedia/elements~MediaObject.ConstructorParams}
 */
