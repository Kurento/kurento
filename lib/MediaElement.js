 ...
 *
 * @private
 * @class   module:KwsMedia~MediaElement
...
//  Object.defineProperty(this, "type", {value : objectRef.type});
   ...
   *
   *
   * @param {module:KwsMedia~MediaElement}        sink
   *  Element to connect
   *
   * @param {module:KwsMedia~MediaPad.MediaType} [type]
   *  Type of the sink pads to be fetched
   *
   * @param {external:String}                    [description]
   *
   *
   * @return {module:KwsMedia~MediaElement}
   *  The element itself
   *
 ...
 */
MediaElement.paramsScheme = MediaContainer.paramsScheme;
