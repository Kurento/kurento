...
function MediaElement(objectRef, parent, pipeline)
{
  ...
  this.getMediaSrcs = function(type, description, callback)
  {
    ...
    else
    {
      ...
      this.emit('request', 'getMediaSrcs', params, function(error, pads)
      {
        if(error)
        {
          callback(error);
  ...
  this.getMediaSinks = function(type, description, callback)
  {
    ...
    else
    {
      ...
      this.emit('request', 'getMediaSinks', params, function(error, pads)
      {
        if(error)
        {
          callback(error);
  ...
  this.connect = function(sink, type, description, callback)
  {
    ...
    this.emit('request', 'connectElements', params, callback);
