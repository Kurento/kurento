 ...
 * @param {module:kwsMediaApi/endpoints~HttpPostEndpoint.constructorParams} params
 */
function HttpPostEndpoint(id, parent, pipeline, params)
{
...
extend(HttpPostEndpoint.constructorParams, HttpEndpoint.constructorParams);
 ...
 * @param {module:kwsMediaApi/endpoints~HttpPostEndpoint.constructorParams} params
 */
HttpPostEndpoint.create = function(pipeline, params, callback)
{
