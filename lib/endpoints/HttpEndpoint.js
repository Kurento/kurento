 ...
 * @param {module:kwsMediaApi/endpoints~HttpEndpoint.constructorParams} params
 */
function HttpEndpoint(id, parent, pipeline, params)
{
...
extend(HttpEndpoint.constructorParams, SessionEndpoint.constructorParams);
