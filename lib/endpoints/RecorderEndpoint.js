 ...
 * @param {module:kwsMediaApi/endpoints~RecorderEndpoint.constructorParams} params
 */
function RecorderEndpoint(id, parent, pipeline, params)
{
  UriEndpoint.call(this, id, parent, pipeline, params);
};
 ...
 * @extend module:kwsMediaApi~UriEndpoint.constructorParams
 *
...
extend(RecorderEndpoint.constructorParams, UriEndpoint.constructorParams);
 ...
 * @param {module:kwsMediaApi/endpoints~RecorderEndpoint.constructorParams} params
 */
RecorderEndpoint.create = function(pipeline, params, callback)
{
