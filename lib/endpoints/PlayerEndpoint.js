 ...
 * @param {module:kwsMediaApi/endpoints~PlayerEndpoint.constructorParams} params
 */
function PlayerEndpoint(id, parent, pipeline, params)
{
...
extend(PlayerEndpoint.constructorParams, UriEndpoint.constructorParams);
 ...
 * @param {module:kwsMediaApi/endpoints~PlayerEndpoint.constructorParams} params
 */
PlayerEndpoint.create = function(pipeline, params, callback)
{
