 ...
 * @param {module:kwsMediaApi/endpoints~SdpEndpoint.constructorParams} params
 */
function SdpEndpoint(id, parent, pipeline, params)
{
  SessionEndpoint.call(this, id, parent, pipeline, params);
};
...
SdpEndpoint.prototype.generateOffer = function(callback){
  this.invoke('generateOffer', callback);
...
SdpEndpoint.prototype.getLocalSessionDescriptor = function(callback){
  this.invoke('getLocalSessionDescriptor', callback);
...
SdpEndpoint.prototype.getRemoteSessionDescriptor = function(callback){
  this.invoke('getRemoteSessionDescriptor', callback);
...
SdpEndpoint.prototype.processAnswer = function(answer, callback){
  ...
  this.invoke('processAnswer', params, callback);
...
SdpEndpoint.prototype.processOffer = function(offer, callback){
  ...
  this.invoke('processOffer', params, callback);
 ...
 * @extend module:kwsMediaApi~SessionEndpoint.constructorParams
 */
SdpEndpoint.constructorParams = {};
extend(SdpEndpoint.constructorParams, SessionEndpoint.constructorParams);
