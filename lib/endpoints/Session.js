 ...
 * @param parent
 * @param pipeline
 * @param {module:KwsMedia~MediaElement.paramsScheme} params
 */
function Session(id, parent, pipeline, params)
{
  MediaElement.call(this, id, parent, pipeline, params);
};
Session.prototype.__proto__   = MediaElement.prototype;
Session.prototype.constructor = Session;


/**
 * @see {@link module:KwsMedia~MediaElement.paramsScheme}
 */
