 ...
 * @param {module:kwsMediaApi/filters~PointerDetectorAdvFilter.constructorParams} params
 */
function PointerDetectorAdvFilter(id, parent, pipeline, params)
{
...
extend(PointerDetectorAdvFilter.constructorParams, Filter.constructorParams);
 ...
 * @param {module:kwsMediaApi/filters~PointerDetectorAdvFilter.constructorParams} params
 */
PointerDetectorAdvFilter.create = function(pipeline, params, callback)
{
