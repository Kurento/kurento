 ...
 * @param {module:kwsMediaApi/filters~PointerDetectorFilter.constructorParams} params
 */
function PointerDetectorFilter(id, parent, pipeline, params)
{
...
extend(PointerDetectorFilter.constructorParams, Filter.constructorParams);
 ...
 * @param {module:kwsMediaApi/filters~PointerDetectorFilter.constructorParams} params
 */
PointerDetectorFilter.create = function(pipeline, params, callback)
{
