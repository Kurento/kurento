 ...
 * @param {module:kwsMediaApi/filters~FaceOverlayFilter.constructorParams} params
 */
function FaceOverlayFilter(id, parent, pipeline, params)
{
...
/**
 * Clear the image to be shown over each detected face. Stops overlying of the faces.
 *
...
extend(FaceOverlayFilter.constructorParams, Filter.constructorParams);
 ...
 * @param {module:kwsMediaApi/filters~FaceOverlayFilter.constructorParams} params
 */
FaceOverlayFilter.create = function(pipeline, params, callback)
{
