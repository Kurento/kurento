...
/**
 * @class
 * @extends module:KwsMedia/elements~JackVaderFilter
 *
 * @param objectRef
 * @param parent
 * @param pipeline
 ...
 */
function JackVaderFilter(objectRef, parent, pipeline, params)
{
  MediaFilter.call(this, objectRef, parent, pipeline, params);
};
JackVaderFilter.prototype.__proto__   = MediaFilter.prototype;
JackVaderFilter.prototype.constructor = JackVaderFilter;
 ...
 */
JackVaderFilter.checkparams = function(params)
{
