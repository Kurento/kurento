 ...
 * @param {module:kwsMediaApi/filters~ZBarFilter.constructorParams} params
 */
function ZBarFilter(id, parent, pipeline, params)
{
...
extend(ZBarFilter.constructorParams, Filter.constructorParams);
 ...
 * @param {module:kwsMediaApi/filters~ZBarFilter.constructorParams} params
 */
ZBarFilter.create = function(pipeline, params, callback)
{
