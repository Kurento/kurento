 ...
 * @param {module:kwsMediaApi/hubs~DispatcherOneToMany.constructorParams} params
 */
function DispatcherOneToMany(id, parent, pipeline, params)
{
...
DispatcherOneToMany.prototype.removeSource = function(callback){
  this.invoke('removeSource', callback);
...
DispatcherOneToMany.prototype.setSource = function(source, callback){
  ...
  this.invoke('setSource', params, callback);
...
extend(DispatcherOneToMany.constructorParams, Hub.constructorParams);
 ...
 * @param {module:kwsMediaApi/hubs~DispatcherOneToMany.constructorParams} params
 */
DispatcherOneToMany.create = function(pipeline, params, callback)
{
  pipeline.createMediaElement('DispatcherOneToMany', params, callback);
};
