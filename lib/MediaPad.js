 ...
 *
 * @param {module:MediaElement} mediaElement - Element owner of this pad
 * @param {module:MediaPad.MediaType} type - Type of this pad
...
function MediaPad(objectRef, parent, pipeline, mediaElement, description)
{
  ...
  /**
   * {@link module:KwsMedia~MediaElement} that owns this {@link module:KwsMedia~MediaPad}
   *
   * @public
   * @readonly
   * @member {module:KwsMedia~MediaElement} mediaElement
   * @memberof module:KwsMedia~MediaPad
   * @instance
   */
  Object.defineProperty(this, "mediaElement", {value : mediaElement});

  /**
   * Type of this {@link module:KwsMedia~MediaPad}
   *
   * @public
   * @readonly
   * @member {module:KwsMedia~MediaPad.MediaType} type
   * @memberof module:KwsMedia~MediaPad
   * @instance
   */
 ...
 * @private
 * @class
 * @extends {module:KwsMedia~MediaPad}
 *
 * @param {module:KwsMedia~MediaElement} mediaElement - Element owner of this pad
 * @param {module:KwsMedia~MediaPad.MediaType} type - Type of this pad
 * @param {external:String} description - Description of this pad
 */
function MediaPadSource(objectRef, parent, pipeline, mediaElement, description)
{
  ...
  this.connect = function(sink, callback)
  {
    ...
    this._rpc('connect', 'source', params, function(error)
    {
  ...
  this.disconnect = function(sink, callback)
  {
    ...
    this._rpc('disconnect', 'source', params, function(error)
    {
      if(error) return callback(error);
   ...
   * @public
   * @readonly
   * @member {module:KwsMedia~MediaPadSink[]} sinks
   * @memberof module:KwsMedia~MediaPadSource
   * @instance
   *
   * @throws {module:KwsMedia~MediaServerException}
   */
...
function MediaPadSink(objectRef, parent, pipeline, mediaElement, description)
{
   ...
   * @memberof module:KwsMedia~MediaPadSink
   * @instance
   */
 ...
 *
 *
 * @typedef {(audio|video|data)} module:KwsMedia~MediaPad.MediaType
 */
