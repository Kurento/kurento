...
MediaObject.prototype.release = function()
{
  ...
  this._rpc('release', 'mediaObject', {}, function(error)
  {
...
MediaObject.prototype.invoke = function(method, params, callback)
{
  ...
  // Do request
  this._rpc('invoke', 'mediaObject', params2, callback);
    ...
    switch(key)
    {
      case 'collectOnUnreferenced':
        if(typeof value != "boolean")
          throw SyntaxError("collectOnUnreferenced param should be Boolean");
      break;
