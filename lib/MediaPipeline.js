...
/**
 * A pipeline is a container for a collection of :rom:cls:`MediaElements<MediaElement>` and :rom:cls:`Hubs<Hub>`. It offers the methods needed to control the creation and connection of elements inside a certain pipeline.
 *
 ...
 * @param {module:kwsMediaApi~MediaPipeline.constructorParams} params
 */
